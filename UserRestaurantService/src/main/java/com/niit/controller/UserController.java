...
//    @GetMapping("/get/addedToFavourites")
    ...
    @GetMapping("/user/get/address/{userId}/{addressId}")
    public ResponseEntity<?> getAddressById(@PathVariable String userId,@PathVariable String addressId){
        return new ResponseEntity<>(userService.getAddressById(userId,addressId),HttpStatus.OK);
    }
...
@GetMapping("/user/addedTo/cart/{id}/{cuisineId}")
    public ResponseEntity<?> addedToCart(@PathVariable String id,@PathVariable String cuisineId){
        return new ResponseEntity<>(userService.addedToCart(id,cuisineId),HttpStatus.OK);
}


@GetMapping("/user/get/cartTotal/{id}")
public ResponseEntity<?> getCartTotal(@PathVariable String id){
        return new ResponseEntity<>(userService.getCartTotal(id),HttpStatus.OK);
}
}
